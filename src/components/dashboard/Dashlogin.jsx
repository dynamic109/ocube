...
const Dashlogin = () => {
    return(
        ...
        <div>< img src={Logo} alt="logo" /></div>  
               <div>
                 <h1 className="text-5xl text-center font-semibold"> Login to your dashboard</h1>
                 <p className="text-[#1B1C1E] text-center text-lg p-3">Enter your details to access your dashboard.</p>
                 <div>
                    <div className="mt-6">
              ...
              <button className="bg-[#148E88] mt-6 text-white rounded-xl md:w-[40%] p-3">Login</button>
